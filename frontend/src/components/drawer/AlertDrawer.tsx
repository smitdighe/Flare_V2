      ...
      {alert && (
        <>
          ...
          <motion.aside
            ...
            className="fixed right-0 top-0 bottom-0 z-50 w-full max-w-[560px] bg-[#030712] border-l border-slate-800/80 shadow-[-10px_0_40px_rgba(0,0,0,0.85)] flex flex-col metal-bevel"
            role="dialog"
            aria-modal="true"
